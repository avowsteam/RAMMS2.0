        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.divisionMiri.length; i++) {
                ...
                $('#tblDivision tbody').append("<tr>"
                    ...
                    + "<td style='text-align: center'>" + assignZero(data.divisionMiri[i].iw) + "</td>"
                    + "<td style='text-align: center'>" + assignZero(data.divisionMiri[i].spi) + "</td>"
                    + "<td style='text-align: center'>" + assignZero(data.divisionMiri[i].plannedPer) + " %</td>"
                    + "<td style='text-align: center'>" + assignZero(data.divisionMiri[i].actualPer) + " %</td>"
                    + "</tr>");
            }
            ...
            for (var i = 0; i < data.rmuMiri.length; i++) {
                $('#tblMiri tbody').append("<tr id='miri_" + i + "' pkid='" + data.rmuMiri[i].pkRefNo + "'>"
                    ...
                    + "<td style='text-align: center' class='editiw allow_numeric'>" + assignZero(data.rmuMiri[i].iw) + "</td>"
                    + "<td style='text-align: center' class='editspi'>" + assignZero(data.rmuMiri[i].spi) + "</td>"
                    + "<td style='text-align: center'>" + assignZero(data.rmuMiri[i].plannedPer) + " %</td>"
                    + "<td style='text-align: center'>" + assignZero(data.rmuMiri[i].actualPer) + " %</td>"
                    + "</tr>");
            }
            ...
            for (var i = 0; i < data.rmuBTN.length; i++) {
                $('#tblBtn tbody').append("<tr id='btn_" + i + "' pkid='" + data.rmuBTN[i].pkRefNo + "'>"
                    ...
                    + "<td style='text-align: center' class='editiw allow_numeric'>" + assignZero(data.rmuBTN[i].iw) + "</td>"
                    + "<td style='text-align: center' class='editspi'>" + assignZero(data.rmuBTN[i].spi) + "</td>"
                    + "<td style='text-align: center'>" + assignZero(data.rmuBTN[i].plannedPer) + " %</td>"
                    + "<td style='text-align: center'>" + assignZero(data.rmuBTN[i].actualPer) + " %</td>"
                    + "</tr>");
            }
        },
        error: function (data) {
