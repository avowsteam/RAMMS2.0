...
namespace RAMMS.Web.UI.Controllers
{
    public class FormB11Controller : Models.BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            grid.Columns.Add(new CDataColumns() { data = null, title = "Action", IsFreeze = true, sortable = false, render = "frmB11.HeaderGrid.ActionRender", className = "" });
        ...
        private async Task<IActionResult> ViewRequest(int id, int IsEdit)
        {
            ...
            if (id > 0)
            {
                ...
                foreach (var yr in newYears)
                {
                    ...
                    if (y < _model.FormB11Header.B11hRevisionYear)
                    {
                        yr.Value = "";
                    }
                }
