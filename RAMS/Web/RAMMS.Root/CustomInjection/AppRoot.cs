...
namespace RAMMS.Root.CustomInjection
{
    ...
    public static class AppRoot
    {
        ...
        private static void InjectServiceDependencies(IServiceCollection services)
        {
            ...
            services.AddTransient<IFormB15Service, FormB15Service>();
            services.AddTransient<IFormB12Service, FormB12Service>();
            services.AddTransient<IFormT3Service, FormT3Service>();
            services.AddTransient<IFormT4Service, FormT4Service>();
            services.AddTransient<IFormP1Service, FormP1Service>();
            services.AddTransient<IFormPAService, FormPAService>();
            services.AddTransient<IDlpSpiService, DlpSpiService>();
        ...
        private static void InjectRepositoryDependencies(IServiceCollection services)
        {
            ...
            services.AddTransient<IFormB15Repository, FormB15Repository>();
            services.AddTransient<IFormB12Repository, FormB12Repository>();
            services.AddTransient<IFormT3Repository, FormT3Repository>();
            services.AddTransient<IFormT4Repository, FormT4Repository>();
            services.AddTransient<IFormP1Repository, FormP1Repository>();
            services.AddTransient<IFormMapRepository, FormMapRepository>();
            services.AddTransient<IFormPARepository, FormPARepository>();
            services.AddTransient<IDlpSpi, DlpSpi>();
            services.AddTransient<IFormPBRepository, FormPBRepository>();
            services.AddTransient<IFormUCUARepository, FormUCUARepository>();
        }
